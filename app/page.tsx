...
const CAT_SUBTITLES = {
  ...
  cloud:  "Can you shift workloads to cloud when hardware is scarce or expensive?",
        ...
        <div id="results-printable" style={{ maxWidth: 560, margin: "0 auto" }}>
          ...
          <div style={{ background: "#fff", borderRadius: 12, padding: 28, marginBottom: 16, boxShadow: "0 2px 12px rgba(0,0,0,0.07)" }}>
            ...
            <div style={{ height: 8, background: "#f3f4f6", borderRadius: 4, overflow: "hidden" }}>
              <div style={{ height: "100%", width: `${(totalScore / 80) * 100}%`, background: overall.border, borderRadius: 4 }} />
            </div>
          </div>
